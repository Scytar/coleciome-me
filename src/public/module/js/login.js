export default () => {
    ...
    <section class="cadastrogin">
        <nav id="navLogin">
            <a id="registerAnchorButton" data-pathname="/cadastro" class="loginTab">Cadastrar</a>
            <a id="LoginAnchorButton" data-pathname="/login" class="selected loginTab">Entrar</a>
        </nav>
        ...
        <div id="conteinerLogin">
            ...
            <input type="email" id="emailLogin" maxlength="80" placeholder="E-mail" required tabindex="1">
